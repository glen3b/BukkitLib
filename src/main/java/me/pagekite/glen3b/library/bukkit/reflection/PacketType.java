...
/**
 * This class is part of DarkBladee's reflection handler and follows the same usage conditions.
 *
 * <p>
...
public enum PacketType {
	...
	public Class<?> getPacket() throws Exception {
		return packet == null ? packet = ReflectionUtilities.Minecraft.getType(name) : packet;
	}
}